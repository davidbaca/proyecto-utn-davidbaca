Nombre de Alumno: David Baca
email: davidnicolasbaca@gmail.com
...
por cuestiones de tiempo no quería tardar más.
    ...
    Para el front use React, Node para el lado del servidor y para la base de datos opté por MongoDB
